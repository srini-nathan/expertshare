                    ...
                    <AppCard>
                        <Form noValidate onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Form.Row>
                                <AppFormInput
                                    name={"pX"}
                                    label={t("admin.aframepanel.form:label.pX")}
                                    maxCount={pX.max}
                                    {...validation("pX", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"pY"}
                                    label={t("admin.aframepanel.form:label.pY")}
                                    maxCount={pY.max}
                                    {...validation("pY", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"pZ"}
                                    label={t("admin.aframepanel.form:label.pZ")}
                                    maxCount={pZ.max}
                                    {...validation("pZ", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"rX"}
                                    label={t("admin.aframepanel.form:label.rX")}
                                    maxCount={rX.max}
                                    {...validation("rX", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"rY"}
                                    label={t("admin.aframepanel.form:label.rY")}
                                    maxCount={rY.max}
                                    {...validation("rY", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"rZ"}
                                    label={t("admin.aframepanel.form:label.rZ")}
                                    maxCount={rZ.max}
                                    {...validation("rZ", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"sX"}
                                    label={t("admin.aframepanel.form:label.sX")}
                                    maxCount={sX.max}
                                    {...validation("sX", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"sY"}
                                    label={t("admin.aframepanel.form:label.sY")}
                                    maxCount={sY.max}
                                    {...validation("sY", formState, isEditMode)}
                                ...
                                <AppFormInput
                                    name={"sZ"}
                                    label={t("admin.aframepanel.form:label.sZ")}
                                    maxCount={sZ.max}
                                    {...validation("sZ", formState, isEditMode)}
                            ...
                            <Form.Row>
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remotePosX?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remotePosY?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remotePosZ?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remoteScaX?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remoteScaY?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remoteScaZ?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remoteRotX?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remoteRotY?.message}
                                ...
                                <AppFormInput
                                    ...
                                    errorMessage={errors.remoteRotZ?.message}
