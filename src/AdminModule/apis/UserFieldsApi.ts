...
const {
    api_user_fields_delete_item: API_DELETE_ITEM,
    api_user_fields_get_item: API_GET_ITEM,
    api_user_fields_get_collection: API_GET_COLLECTION,
    api_user_fields_put_item: API_PUT_ITEM,
    api_user_fields_patch_item: API_PATCH_ITEM,
