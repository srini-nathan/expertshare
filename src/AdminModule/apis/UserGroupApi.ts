...
const {
    api_user_groups_delete_item: API_DELETE_ITEM,
    api_user_groups_get_item: API_GET_ITEM,
    api_user_groups_get_collection: API_GET_COLLECTION,
    api_user_groups_put_item: API_PUT_ITEM,
    api_user_groups_patch_item: API_PATCH_ITEM,
    api_user_groups_post_collection: API_POST_COLLECTION,
} = ROUTES;
