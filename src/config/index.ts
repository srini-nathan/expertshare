...
const { FILETYPEINFO_VOTEOPTION_POSTER, FILETYPEINFO_USER_PROFILE, FILETYPEINFO_EXHIBITOR_POSTER, FILETYPEINFO_EXHIBITORLOGO_POSTER, FILETYPEINFO_EXHIBITORVIDEO_MEDIA, FILETYPEINFO_EXHIBITORPRODUCT_POSTER } = FILE_TYPE_INFO;
...
// UploadImage types
const { FILETYPE_VOTEOPTION_POSTER, FILETYPE_EXHIBITOR_POSTER, FILETYPE_EXHIBITORLOGO_POSTER, FILETYPE_USER_PROFILE, FILETYPE_EXHIBITORVIDEO_MEDIA, FILETYPE_EXHIBITORPRODUCT_POSTER } = FILE_TYPE;
